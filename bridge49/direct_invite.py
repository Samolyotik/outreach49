...
#: Начала письма. Ни одно не предполагает, что человек только что согласился.
#:
#: Прежние предполагали: «Отлично, тогда…», «Хорошо, тогда проще показать».
#: Пока письмо заменяло ответ движка, это было верно — оно уходило только на
#: ход согласия. Теперь письмо дописывается к ответу и уходит в том числе туда,
#: где движок сам задал вопрос, и «Отлично.» сразу после «какое направление вам
#: приоритетнее?» читается как ответ на несказанное. Проверено на прогоне
#: 06.08: ход про химчистку кончался вопросом, а письмо начиналось с «Отлично».
_DEMO_OPENINGS = (
    "Посмотреть, как {brand} работает на практике, можно в нашем демо-боте.",
    "Показать проще, чем рассказать: у нас есть демо-бот {brand}.",
    "Как это выглядит на практике, видно в демо-боте {brand}.",
    "Живьём {brand} проще всего посмотреть в демо-боте.",
)
_DEMO_INSIDE = (
